...
<body>
    <form action="" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="judul_buku" <?php echo (isset($_GET['id_buku'])) ?  "value = " . $result[0]["judul_buku"] . "" : "value = '' "; ?> required> <br>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="thn_terbit" <?php echo (isset($_GET['id_buku'])) ?  "value = " . $result[0]["thn_terbit"] . "" : "value = '' "; ?> required> <br>
    ...
    if (isset($_POST['submit'])) {
        tambahdatabuku($_POST['judul_buku'], $_POST['penulis'], $_POST['penerbit'], $_POST['thn_terbit']);
    }
